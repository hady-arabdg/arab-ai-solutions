  ...
  const sectors = [
    {
      icon: Building2,
      title: "قطاع العقارات",
      description: "تتبع العملاء المحتملين، الممارسة الصحيحة للبيع عبر الواتساب والإيميل، المتابعة والفولو أب الاحترافي، فلترة العملاء، واستخدام خبرات التقفيل.",
    ...
    },
    {
      icon: Briefcase,
      title: "قطاع الخدمات",
      description: "حلول بيع B2B متكاملة، تصميم قمع مبيعات احترافي، أتمتة سير العمل، ورفع معدلات التحويل بالذكاء الاصطناعي.",
      image: servicesImage,
      link: "/services",
    },
  ];
      ...
      <div className="container mx-auto relative z-10">
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            تحسين العمليات الداخلية للشركات من خلال الذكاء الاصطناعي وسير العمل الذكي
          </p>
        </div>
        ...
        <div className="mt-20 text-center bg-gradient-to-br from-card to-card/50 backdrop-blur-sm rounded-2xl p-12 border border-primary/20 animate-fade-in">
          <h3 className="text-3xl font-bold mb-4">
            جاهز لتحويل شركتك رقميًا؟
          </h3>
          <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
            انضم للشركات السعودية الرائدة التي تستخدم حلولنا المدعومة بالذكاء الاصطناعي
          </p>

...
const Results = () => {
  const results = [
    ...
    },
    {
      ...
      percentage: "95%",
      title: "دقة الحلول",
      description: "حلول مخصصة تتناسب مع احتياجاتك بدقة عالية",
    },
    {
      icon: Zap,
      percentage: "50%",
      title: "توفير الوقت",
      description: "تقليل الوقت المستغرق في المهام الروتينية",
    },
    {
      icon: Award,
      percentage: "100%",
      title: "رضا العملاء",
      description: "التزامنا بالجودة ينعكس في رضا عملائنا",
    },
  ];
      ...
      <div className="container mx-auto relative z-10">
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            أرقام حقيقية تعكس تأثير حلولنا على شركاتنا الشريكة
          </p>
        </div>
          ...
          {results.map((result, index) => (
            ...
            >
              ...
              <div className="relative">
                ...
                <div className="text-5xl font-bold mb-2 bg-gradient-to-l from-primary to-secondary bg-clip-text text-transparent">
                  {result.percentage}
                </div>
        ...
        <div className="max-w-4xl mx-auto bg-gradient-to-br from-card/50 to-card/30 backdrop-blur-sm rounded-2xl p-12 border border-primary/20 text-center animate-fade-in">
          ...
          <blockquote className="text-2xl md:text-3xl font-semibold mb-6 text-foreground">
            "حلول عرب AI ساعدتنا على تحقيق نقلة نوعية في أداء شركتنا، مع تحسين وصل إلى 85% في كفاءة العمليات"
          </blockquote>
          
          <div className="flex items-center justify-center gap-4">
            <div className="text-right">
              <div className="font-bold text-lg">محمد العتيبي</div>
              <div className="text-muted-foreground">مدير تنفيذي، شركة التقنية المتقدمة</div>
            </div>
          </div>
        </div>
      </div>

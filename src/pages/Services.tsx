...
const ServicesPage = () => {
  const { t } = useLanguage();
  const features = [
    { icon: Users, title: t("sv.f1.title"), description: t("sv.f1.desc") },
    { icon: GitBranch, title: t("sv.f2.title"), description: t("sv.f2.desc") },
    { icon: Mail, title: t("sv.f3.title"), description: t("sv.f3.desc") },
    { icon: TrendingUp, title: t("sv.f4.title"), description: t("sv.f4.desc") },
    { icon: Zap, title: t("sv.f5.title"), description: t("sv.f5.desc") },
    { icon: Briefcase, title: t("sv.f6.title"), description: t("sv.f6.desc") },
  ];
  const steps = [
    { n: 1, title: t("sv.s1.title"), desc: t("sv.s1.desc") },
    { n: 2, title: t("sv.s2.title"), desc: t("sv.s2.desc") },
    { n: 3, title: t("sv.s3.title"), desc: t("sv.s3.desc") },
  ];
    ...
    <div className="min-h-screen bg-background">
      <section className="relative py-32 px-4 overflow-hidden">
        <div className="absolute inset-0">
          <img src={sectorImage} alt="Services Sector" className="w-full h-full object-cover opacity-20" />
        ...
        <div className="container mx-auto relative z-10">
          ...
          <div className="max-w-3xl animate-fade-in">
            <h1 className="text-5xl md:text-6xl font-bold mb-6">
              <span className="bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">{t("sv.hero.title1")}</span>
              <br />
              {t("sv.hero.title2")}
            </h1>
            <p className="text-xl text-muted-foreground mb-8">{t("sv.hero.subtitle")}</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-4">
        <div className="container mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">{t("sv.features.subtitle")}</p>
          </div>
      ...
      <section className="py-24 px-4 bg-card/30">
        <div className="container mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-4">
              <span className="bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">{t("sv.funnel.title")}</span>
            </h2>
          </div>
